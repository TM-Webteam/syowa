...
<head>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-PJMWJ26S');
  </script>
...
<?php if (!empty($class)) : ?>
  ...
  <?php else : ?>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PJMWJ26S" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
